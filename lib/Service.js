...
export default class Service {
    async run(name, args = {}, rawArgv = []) {
        ...
        await WebpackPlugins.providePlugin(this.webpackConfig);
        ...
        await WebpackModules.jquery(this.webpackConfig, !this.isProduction);
    ...
    async webpackConfigOutput() {
        let outputPathName = "dist";
        if (this.mode === 'development') {
            outputPathName = "dist-dev";
        }
        const outputPath = path.resolve(this.appDirectory, outputPathName);
